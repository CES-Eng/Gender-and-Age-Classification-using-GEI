...
if (os.path.isfile(ffile)):
    ...
    del df["ID"]
    filestring = os.path.join(os.path.dirname(os.path.abspath(__file__)),ffile)
    df.to_csv(filestring, encoding='utf-8', index=False)
    print("fileout")
...
FCLmodel = Sequential([
    Dense(32, activation='relu', input_shape=(len(df.columns)-1,)),
